"""Entry point: run the demo engagement, open the 3D viewer in a browser,
and append the run to the CSV logbooks in output/logbook/.
...
def build_and_run():
    """Construct the demo scenario and run it to resolution."""
...
def main():
    ...
    run_timestamp = append_run(sim)
    print(f"Run appended to output/logbook/ (runs.csv, threats.csv, sensors.csv) as {run_timestamp}")
